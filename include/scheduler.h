...
namespace Scheduling_Criteria
{
    ...
    public:
        ...
        static const bool power_cap = false; // enables power_capping
    ...
    public:
     ...
     public:
      ...
      public:
          ...
          MGEDF(const Microsecond & d, const Microsecond & p = SAME, const Microsecond & c = UNKNOWN, int cpu = ANY)
          : GEDF(d, p, c, cpu) {}
      ...
      public:
          ...
          static const bool power_cap = false;
      public:
          static void init() {
            PMU::stop(0);
            PMU::stop(1);
          ...
          MPEDF(const Microsecond & d, const Microsecond & p = SAME, const Microsecond & c = UNKNOWN, int cpu = ANY)
          : PEDF(d, p, c, cpu) {}
      ...
      public:
          ...
          MCEDF(const Microsecond & d, const Microsecond & p = SAME, const Microsecond & c = UNKNOWN, int cpu = ANY)
          : CEDF(d, p, c, cpu) {}
      };
}
