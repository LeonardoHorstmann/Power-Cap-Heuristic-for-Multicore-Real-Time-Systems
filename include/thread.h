...
protected:
    ...
    static volatile unsigned int _power_suspended_count[Traits<Build>::CPUS]; //counts power-cap suspended
...
public:
    ...
    static volatile unsigned int _clock_min[Traits<Build>::CPUS]; //used to stabilished minimum clock factors
